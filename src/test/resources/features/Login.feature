...
Feature: Login & Logout Scenarios
  ...
  Scenario: 1 Verify that the user can log in with the correct information
    Given User goes to login page
     When User logins as "5463003098" and "11111111" and "1"
     Then User should see homePage displayed

  Scenario: 2 Verify that the user receives an error warning when logging in with incorrect information
    Given User goes to login page
     When User logs in with the wrong password
     Then User should see errorText displayed
